...
public class StepDetector extends AbstractStepDetector {
    public static final int ALGORITHM_ID = 1;

    private static final int ACCEL_RING_SIZE = 50; // 加速度采样数
    private static final int VEL_RING_SIZE = 10; // 速度采样数
